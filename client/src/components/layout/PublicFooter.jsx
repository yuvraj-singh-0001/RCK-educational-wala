        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-links mt-3">
              <button className="footer-link" onClick={() => onSectionJump('hero')} type="button">
                Home
              </button>
              <button className="footer-link" onClick={() => onSectionJump('courses')} type="button">
                Courses
              </button>
              ...
              <button className="footer-link" onClick={() => onSectionJump('contact')} type="button">
                Contact
              </button>
