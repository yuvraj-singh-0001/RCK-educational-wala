    ...
    <div className="w-full min-h-screen bg-[#06060c]">
      ...
      <div className="bg-[#0e0e1b] border-b border-white/10 px-4 py-2 flex items-center justify-between text-xs sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="https://wa.me/918601300910?text=Hi%20SiteMint!%20I%20like%20the%20Education%20Portal%20Demo%20and%20want%20to%20order%20it%20for%20my%20coaching/school."
            target="_blank"
