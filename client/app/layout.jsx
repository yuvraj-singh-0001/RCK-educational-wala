...
export const metadata = {
  ...
  keywords: [
    ...
    'android and ios mobile app development india starting 12999',
    'cheap and best android ios app developer india',
    'google play store publishing free app development package',
    'website with google analytics ga4 traffic tracking',
  ...
  return (
    <html lang="en" className="scroll-smooth overflow-x-hidden w-full max-w-full">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Caveat:wght@500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
        <script
