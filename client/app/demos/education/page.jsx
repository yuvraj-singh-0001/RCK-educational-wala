  ...
  loading: () => (
    <div className="min-h-screen bg-[#06060c] text-white flex items-center justify-center">
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="text-xs text-zinc-400 font-medium">Loading Live Education Demo...</span>
      </div>
    </div>
  ),
});

export default function DemosEducationPage() {
  return (
    <div className="w-full min-h-screen bg-[#06060c]">
      ...
      <div className="bg-[#0e0e1b] border-b border-white/10 px-4 py-2 flex items-center justify-between text-xs sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2">
          <span className="hidden sm:inline text-zinc-400">Like this education portal?</span>
          <a
            href="https://wa.me/918601300910?text=Hi%20SiteMint!%20I%20want%20to%20order%20the%20Education/Coaching%20Portal%20Package."
            target="_blank"
            rel="noopener noreferrer"
            className="btn-whatsapp !py-1 !px-3 !text-xs !rounded-md"
          >
            <MessageCircle className="w-3.5 h-3.5" /> Order Portal (₹7,999)
          </a>
        </div>
      </div>
