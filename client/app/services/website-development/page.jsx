  ...
  const plans = {
    ...
    business: {
      ...
      keyPoints: [
        ...
        '350 Free Lead & Order Transactional Emails per Day via Gmail API (Zero Monthly Cost)',
    ...
    professional: {
      ...
      keyPoints: [
        ...
        '350 Free Transactional & Alert Emails per Day via Gmail API (Zero Software Fees)',
