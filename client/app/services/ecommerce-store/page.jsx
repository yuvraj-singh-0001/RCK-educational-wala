...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://sitemint.in/services/ecommerce-store',
  },
  openGraph: {
    ...
    url: 'https://sitemint.in/services/ecommerce-store',
  },
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-center mb-12 sm:mb-16">
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 mb-6 sm:mb-8">
              <a
                href="https://wa.me/918601300910?text=Hi%20SiteMint!%20I%20want%20to%20build%20an%20E-Commerce%20Store%20for%20my%20products.%20Please%20share%20details."
                target="_blank"
          ...
          <div className="lg:col-span-5">
            <div className="glass-card p-5 sm:p-8 bg-slate-900 text-white border border-slate-800 shadow-xl shadow-slate-900/20">
              ...
              <a
                href="https://wa.me/918601300910?text=Hi%20SiteMint!%20I%20want%20to%20order%20the%20E-Commerce%20Store%20Package."
                target="_blank"
                rel="noopener noreferrer"
